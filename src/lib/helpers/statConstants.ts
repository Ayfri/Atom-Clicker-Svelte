...
export const statsConfig: Record<string, StatConfig> = {
	...
	totalBonusHiggsBosonClicked: { defaultValue: 0, layer: LAYERS.PROTONIZER, minVersion: 10 },
	...
	totalExcitedPhotonsEarned: { defaultValue: 0, layer: LAYERS.NEVER, minVersion: 16 },
...
export const STATS = {
	...
	TOTAL_BONUS_HIGGS_BOSON_CLICKED: 'totalBonusHiggsBosonClicked',
	...
	TOTAL_EXCITED_PHOTONS_EARNED: 'totalExcitedPhotonsEarned',
