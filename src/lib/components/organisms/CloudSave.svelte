...
>
    <div
        class="modal flex h-dvh w-screen md:h-[85vh] md:w-[85vw] max-w-xl flex-col overflow-hidden md:rounded-2xl shadow-2xl bg-linear-to-br from-accent-900 to-accent-800"
